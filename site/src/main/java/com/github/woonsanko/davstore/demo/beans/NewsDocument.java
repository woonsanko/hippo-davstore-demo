...
public class NewsDocument extends HippoDocument {
     ...
     */
    public static final String DOCUMENT_TYPE = "hippodavstoredemo:newsdocument";
    ...
    private static final String AUTHOR = "hippodavstoredemo:author";
    private static final String SOURCE = "hippodavstoredemo:source";
